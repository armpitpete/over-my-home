...
The accessible aircraft cards remain snapshots of the last real provider response. Only the graphical radar positions are extrapolated between corrections. People who request reduced motion receive only the real three-minute position updates.
